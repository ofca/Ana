...
class UTF8 {
     ...
     * @param   string  $charset    character set, defaults to UTF8::$charset
     * @return  mixed
    ...
    public static function transliterateToAscii($str, $case = 0)
    {
        ...
        {
            require 'functions/'.__FUNCTION__.'.php';
    ...
    {
        if (UTF8::$serverUtf8)
            return mb_strpos($str, $search, $offset, UTF8::$charset);
    ...
    {
        if (UTF8::$serverUtf8)
            return mb_strrpos($str, $search, $offset, UTF8::$charset);
    ...
    public static function substr($str, $offset, $length = NULL)
    {
        if (UTF8::$serverUtf8)
            return ($length === NULL)
                ? mb_substr($str, $offset, mb_strlen($str), UTF8::$charset)
                : mb_substr($str, $offset, $length, UTF8::$charset);
    ...
    {
        if (UTF8::$serverUtf8)
            return mb_strtolower($str, UTF8::$charset);
    ...
    {
        if (UTF8::$serverUtf8)
            return mb_strtoupper($str, UTF8::$charset);
...
if (UTF8::$serverUtf8 === NULL)
{
    // Determine if this server supports UTF-8 natively
    UTF8::$serverUtf8 = extension_loaded('mbstring');
}
